...
if args.autogenerate:
    ...
    generator(phoneGen.generate_invalid_international)
    generator(phoneGen.generate_valid_international)
    generator(phoneGen.generate_invalid_hungary)
    generator(phoneGen.generate_valid_hungary)
